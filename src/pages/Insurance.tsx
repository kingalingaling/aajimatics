...
import insuranceHero from "../assets/images/other-heroes/ins.jpg"; // Replace with your insurance/umbrella image
      ...
      <main className="grow pt-28 pb-20 px-4 sm:px-6 lg:px-8">
        ...
        <div className="container mx-auto max-w-5xl mt-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {/* Project 1: Cyber Insurance Enablement */}
            <ProjectCard 
              text="Cyber insurance enablement via CIDA platform"
              icon={
            ...
            {/* Project 2: Claims Management */}
            <ProjectCard 
              text="Claims management automation for underwriting firms"
              icon={
            ...
            {/* Project 3: Policy Administration */}
            <ProjectCard 
              text="Policy administration portals with analytics layers"
              icon={
